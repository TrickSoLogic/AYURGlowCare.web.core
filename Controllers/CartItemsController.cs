...
namespace AYURGlowCare.web.core.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,Quantity,TotalPrice")] CartItem cartItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,Quantity,TotalPrice")] CartItem cartItem)
        {
            if (id != cartItem.Id)
            {
                return NotFound();
